...
public class Carga_LoginRegister extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Carga_LoginRegister(JFrame frame,JPanel panelcontenedordalso) {
		...
		label.setIcon(new ImageIcon(Carga_LoginRegister.class.getResource("/Imagenes/giphy.gif")));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setBounds(10, 116, 450, 156);
		panel.add(label);
		
		JLabel label_1 = new JLabel("Cargando registro");
		...
		Thread hilo=new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					new CambiaPanel(panel_3, new Registro(frame,panelcontenedordalso));
