...
public class MaterialComboBox<T> extends JComboBox<T> {
	...
	public static class FieldRenderer<T> extends JComponent implements ListCellRenderer<T> {
        ...
        public FieldRenderer(@SuppressWarnings("rawtypes") MaterialComboBox comboBox) {
            this.comboBox = comboBox;
        }

        @Override
        public Component getListCellRendererComponent(@SuppressWarnings("rawtypes") JList jList, Object o, int index, boolean isSelected, boolean cellHasFocus) {
    ...
    public static class Popup extends BasicComboPopup {
		...
		public Popup(@SuppressWarnings("rawtypes") JComboBox combo) {
            super(combo);
    ...
    public static class ScrollBar extends JScrollBar {
		...
		public ScrollBar(@SuppressWarnings("rawtypes") final JComboBox comboBox, int orientation) {
            super(orientation);
